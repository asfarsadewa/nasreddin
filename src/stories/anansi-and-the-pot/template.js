export function createStoryTemplate() {
  return `
    <main id="experience" class="anansi-story">
      <div id="canvas-stage" aria-hidden="true"></div>
      <div class="anansi-weave" aria-hidden="true"></div>
      ...
      <section class="opening" id="opening" aria-labelledby="story-title">
        ...
        <button class="language-launch language-launch--opening" type="button" data-language-menu aria-haspopup="dialog" aria-controls="language-panel">
          <span class="language-launch__pulse" aria-hidden="true"></span><span data-language-summary>EN · CC ID</span>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="m8 10 4 4 4-4" /></svg>
        </button>
        <p class="opening__eyebrow" id="opening-eyebrow">An Akan Anansesem · cinematically retold</p>
        <p class="opening__akan" aria-hidden="true">KWAKU ANANSE · NTIKUMA</p>
        <h1 id="story-title"><span>Anansi</span><span class="opening__join">and the <i>Pot</i></span></h1>
        <p class="opening__deck" id="opening-deck">He gathered every scrap of wisdom—except the one waiting beneath the tree.</p>
        <button class="begin" id="begin" type="button" disabled>
          ...
          <span><b id="begin-label">Preparing the story</b><small id="load-status">Loading voices, score & sound…</small></span>
        </button>
        <p class="opening__hint">Headphones recommended · about two minutes</p>
        <span class="opening__gourd" aria-hidden="true"><i></i><b></b></span>
      </section>
      ...
      <header class="hud" id="hud" aria-hidden="true" hidden>
        <div class="hud__identity">
          ...
          <div class="hud__mark"><span>ANANSESEM</span><i aria-hidden="true"></i><span id="tale-mark">An Akan Anansesem</span></div>
        </div>
      ...
      <div class="chapter" id="chapter" aria-hidden="true" hidden><span id="chapter-number">I</span><div><small id="chapter-label">Chapter</small><strong id="chapter-name">Wisdom gathered</strong></div></div>
      ...
      <section class="language-panel" id="language-panel" role="dialog" aria-modal="true" aria-labelledby="language-title" hidden>
        <header class="language-panel__header"><div><p id="language-eyebrow">Listening options</p><h2 id="language-title">Hear it your way</h2></div>
        ...
        <p class="language-panel__intro" id="language-intro">Choose the performed language and the words shown on screen independently.</p>
        <fieldset class="language-group"><legend><span id="voice-label">Voice</span><small id="voice-help">Fully acted narration</small></legend>
          <div class="language-group__choices language-group__choices--three" role="radiogroup" aria-labelledby="voice-label">
            <button class="language-choice" type="button" role="radio" aria-checked="true" data-voice="en"><span><b>EN</b><strong data-language-name="english">English</strong></span><i aria-hidden="true"></i></button>
        ...
        <fieldset class="language-group"><legend><span id="subtitle-label">Subtitles</span><small id="subtitle-help">Choose independently from the voice</small></legend>
          <div class="language-group__choices language-group__choices--subtitles language-group__choices--four" role="radiogroup" aria-labelledby="subtitle-label">
            ...
            <button class="language-choice" type="button" role="radio" aria-checked="false" data-subtitle="off"><span><b>—</b><strong id="subtitle-off">Off</strong></span><i aria-hidden="true"></i></button>
          </div>
        </fieldset>
      </section>

      <section class="ending" id="ending" aria-labelledby="ending-title" aria-hidden="true" hidden>
        <p id="ending-eyebrow">When the gourd opened</p><h2 id="ending-title">Wisdom could be gathered.<br>It could not be kept.</h2>
        <div class="ending__actions"><button class="replay" id="replay" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 8V3m0 0h5M4 3l4 4a7 7 0 1 1-2 8" /></svg><span id="replay-label">Tell it again</span></button>
