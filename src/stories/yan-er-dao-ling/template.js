export function createStoryTemplate() {
  return `
    <main id="experience" class="bell-story">
      <div id="canvas-stage" aria-hidden="true"></div>
      <div class="bell-atmosphere" aria-hidden="true"></div>
      ...
      <section class="opening" id="opening" aria-labelledby="story-title">
        ...
        <button class="language-launch language-launch--opening" type="button" data-language-menu aria-haspopup="dialog" aria-controls="language-panel">
          <span class="language-launch__pulse" aria-hidden="true"></span><span data-language-summary>中文 · CC EN</span>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="m8 10 4 4 4-4" /></svg>
        </button>
        <p class="opening__eyebrow" id="opening-eyebrow">中国古代寓言 · 电影化短篇</p>
        <h1 id="story-title"><span>掩耳</span><span class="opening__join"><i>盗</i>铃</span></h1>
        <p class="opening__deck" id="opening-deck">他捂住自己的耳朵，以为整个世界也会随之安静。</p>
        ...
        <span class="opening__seal" aria-hidden="true">寓</span>
      </section>
      ...
      <header class="hud" id="hud" aria-hidden="true" hidden>
        <div class="hud__identity">
          ...
          <div class="hud__mark"><span>吕氏春秋</span><i aria-hidden="true"></i><span id="tale-mark">中国古代寓言</span></div>
        </div>
      ...
      <div class="chapter" id="chapter" aria-hidden="true" hidden><span id="chapter-number">I</span><div><small id="chapter-label">章</small><strong id="chapter-name">院中铜钟</strong></div></div>
      ...
      <section class="language-panel" id="language-panel" role="dialog" aria-modal="true" aria-labelledby="language-title" hidden>
        <header class="language-panel__header"><div><p id="language-eyebrow">播放选项</p><h2 id="language-title">选择你的听法</h2></div>
      ...
      <section class="ending" id="ending" aria-labelledby="ending-title" aria-hidden="true" hidden>
        <p id="ending-eyebrow">寓意</p><h2 id="ending-title">捂住耳朵，<br>世界仍然听得见。</h2>
        <div class="ending__actions"><button class="replay" id="replay" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 8V3m0 0h5M4 3l4 4a7 7 0 1 1-2 8" /></svg><span id="replay-label">再听一遍</span></button>
