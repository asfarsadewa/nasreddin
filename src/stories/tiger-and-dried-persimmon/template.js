export function createStoryTemplate() {
  return `
    <main id="experience" class="persimmon-story">
      <div id="canvas-stage" aria-hidden="true"></div>
      <div class="persimmon-wash" aria-hidden="true"></div>
      ...
      <section class="opening" id="opening" aria-labelledby="story-title">
        <a class="collection-back collection-back--opening" href="/" data-collection-back>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H6m5-5-5 5 5 5" /></svg><span>Semua cerita</span>
        </a>
        <button class="language-launch language-launch--opening" type="button" data-language-menu aria-haspopup="dialog" aria-controls="language-panel">
          <span class="language-launch__pulse" aria-hidden="true"></span><span data-language-summary>ID · CC 中文</span>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="m8 10 4 4 4-4" /></svg>
        </button>
        <p class="opening__eyebrow" id="opening-eyebrow">Cerita rakyat Korea · dituturkan secara sinematik</p>
        <p class="opening__hangul" aria-hidden="true">호랑이와 곶감</p>
        <h1 id="story-title"><span>Harimau</span><span class="opening__join">dan <i>Kesemek Kering</i></span></h1>
        <p class="opening__deck" id="opening-deck">Seekor harimau yang lapar mendengar satu kata kecil—lalu ketakutannya membuat kata itu menjadi raksasa.</p>
        ...
        <span class="opening__fruit" aria-hidden="true"><i></i></span>
      </section>
      ...
      <header class="hud" id="hud" aria-hidden="true" hidden>
        <div class="hud__identity">
          ...
          <div class="hud__mark"><span>호랑이와 곶감</span><i aria-hidden="true"></i><span id="tale-mark">Cerita rakyat Korea</span></div>
        </div>
      ...
      <div class="chapter" id="chapter" aria-hidden="true" hidden><span id="chapter-number">I</span><div><small id="chapter-label">Bab</small><strong id="chapter-name">Jejak di malam hari</strong></div></div>
      ...
      <section class="language-panel" id="language-panel" role="dialog" aria-modal="true" aria-labelledby="language-title" hidden>
        <header class="language-panel__header"><div><p id="language-eyebrow">Pilihan mendengarkan</p><h2 id="language-title">Nikmati dengan caramu</h2></div>
        ...
        <fieldset class="language-group"><legend><span id="subtitle-label">Subtitle</span><small id="subtitle-help">Boleh berbeda dari bahasa suara</small></legend>
          <div class="language-group__choices language-group__choices--subtitles language-group__choices--four" role="radiogroup" aria-labelledby="subtitle-label">
            ...
            <button class="language-choice" type="button" role="radio" aria-checked="true" data-subtitle="zh"><span><b>CC</b><strong data-language-name="chinese">中文</strong></span><i aria-hidden="true"></i></button>
      ...
      <section class="ending" id="ending" aria-labelledby="ending-title" aria-hidden="true" hidden>
        <p id="ending-eyebrow">Saat fajar</p><h2 id="ending-title">Yang ditakuti sang harimau<br>hanyalah santapan kecil.</h2>
        <div class="ending__actions"><button class="replay" id="replay" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 8V3m0 0h5M4 3l4 4a7 7 0 1 1-2 8" /></svg><span id="replay-label">Ceritakan lagi</span></button>
          <a class="collection-back collection-back--ending" href="/" data-collection-back><span>Semua cerita</span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h13m-5-5 5 5-5 5" /></svg></a></div>
      </section>
