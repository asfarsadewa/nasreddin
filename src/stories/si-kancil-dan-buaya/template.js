export function createStoryTemplate() {
  return `
    <main id="experience" class="kancil-story">
      <div id="canvas-stage" aria-hidden="true"></div>
      <div class="river-count" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div>
      ...
      <section class="opening" id="opening" aria-labelledby="story-title">
        <a class="collection-back collection-back--opening" href="/" data-collection-back>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H6m5-5-5 5 5 5" /></svg><span>All stories</span>
        </a>
        <button class="language-launch language-launch--opening" type="button" data-language-menu aria-haspopup="dialog" aria-controls="language-panel">
          <span class="language-launch__pulse" aria-hidden="true"></span><span data-language-summary>ID · CC EN</span>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="m8 10 4 4 4-4" /></svg>
        </button>
        <p class="opening__eyebrow" id="opening-eyebrow">Fabel Indonesia · dituturkan secara sinematik</p>
        <p class="opening__count" aria-hidden="true">SATU · DUA · TIGA · EMPAT · LIMA · ENAM · TUJUH · DELAPAN</p>
        <h1 id="story-title"><span>Si Kancil</span><span class="opening__join">dan <i>Buaya</i></span></h1>
        <p class="opening__deck" id="opening-deck">Delapan buaya lapar. Satu sungai sempit. Satu hitungan yang sangat cermat.</p>
        <button class="begin" id="begin" type="button" disabled>
          ...
          <span><b id="begin-label">Menyiapkan kisah</b><small id="load-status">Memuat suara, musik & efek…</small></span>
        </button>
        <p class="opening__hint">Disarankan memakai headphone · sekitar dua menit</p>
        <div class="opening__crossing" aria-hidden="true"><span></span><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div>
      </section>
      ...
      <header class="hud" id="hud" aria-hidden="true" hidden>
        <div class="hud__identity">
          ...
          <div class="hud__mark"><span>SI KANCIL</span><i aria-hidden="true"></i><span id="tale-mark">Fabel Indonesia</span></div>
        </div>
      ...
      <div class="chapter" id="chapter" aria-hidden="true" hidden><span id="chapter-number">I</span><div><small id="chapter-label">Bab</small><strong id="chapter-name">Sungai yang sempit</strong></div></div>
      ...
      <section class="language-panel" id="language-panel" role="dialog" aria-modal="true" aria-labelledby="language-title" hidden>
        <header class="language-panel__header"><div><p id="language-eyebrow">Pilihan mendengarkan</p><h2 id="language-title">Dengarkan sungai dengan caramu</h2></div>
        ...
        <p class="language-panel__intro" id="language-intro">Pilih bahasa suara dan tulisan di layar secara terpisah.</p>
        <fieldset class="language-group"><legend><span id="voice-label">Suara</span><small id="voice-help">Narasi dengan pemeran lengkap</small></legend>
          <div class="language-group__choices language-group__choices--three" role="radiogroup" aria-labelledby="voice-label">
            ...
            <button class="language-choice" type="button" role="radio" aria-checked="false" data-voice="zh"><span><b>中</b><strong data-language-name="chinese">中文</strong></span><i aria-hidden="true"></i></button>
            <button class="language-choice" type="button" role="radio" aria-checked="true" data-voice="id"><span><b>ID</b><strong data-language-name="indonesian">Bahasa Indonesia</strong></span><i aria-hidden="true"></i></button>
          </div>
        </fieldset>
        <fieldset class="language-group"><legend><span id="subtitle-label">Subtitle</span><small id="subtitle-help">Boleh berbeda dari bahasa suara</small></legend>
          <div class="language-group__choices language-group__choices--subtitles language-group__choices--four" role="radiogroup" aria-labelledby="subtitle-label">
            <button class="language-choice" type="button" role="radio" aria-checked="true" data-subtitle="en"><span><b>CC</b><strong data-language-name="english">English</strong></span><i aria-hidden="true"></i></button>
            ...
            <button class="language-choice" type="button" role="radio" aria-checked="false" data-subtitle="id"><span><b>CC</b><strong data-language-name="indonesian">Bahasa Indonesia</strong></span><i aria-hidden="true"></i></button>
            <button class="language-choice" type="button" role="radio" aria-checked="false" data-subtitle="off"><span><b>—</b><strong id="subtitle-off">Tanpa subtitle</strong></span><i aria-hidden="true"></i></button>
          </div>
        </fieldset>
      </section>

      <section class="ending" id="ending" aria-labelledby="ending-title" aria-hidden="true" hidden>
        <p id="ending-eyebrow">Di tepi seberang</p><h2 id="ending-title">Delapan buaya selesai dihitung.<br>Seekor kancil lolos dari tangkapan.</h2>
        <div class="ending__actions"><button class="replay" id="replay" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 8V3m0 0h5M4 3l4 4a7 7 0 1 1-2 8" /></svg><span id="replay-label">Menyeberang lagi</span></button>
          <a class="collection-back collection-back--ending" href="/" data-collection-back><span>All stories</span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h13m-5-5 5 5-5 5" /></svg></a></div>
      </section>
